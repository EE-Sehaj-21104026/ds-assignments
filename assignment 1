...
int main()
{
    Node *head = NULL;
    int n;
    cout << "Enter the numbre of family members to be inserted into the linked list : ";
    cin >> n;
    string member;
    string name;
    int age;
    ...
    cout << "1. Add member at beginning" << endl
         << "2. Add member at end" << endl
...
//the family members can be linked on the basis of age that will be simple sorting 
